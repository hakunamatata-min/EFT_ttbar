...
echo "output: $output"
wrong="f"
cd /afs/cern.ch/user/y/yuekai/EFT-ttbar/scale_factor/btag_eff/2018/condor_out_MC/$1
file=$(ls ${1}.txt)
dir_f=$(cat $file)
...
mv $output/out*.txt /afs/cern.ch/user/y/yuekai/EFT-ttbar/scale_factor/btag_eff/2018/condor_out_MC/$1
if [[ $wrong == "f" ]]
then

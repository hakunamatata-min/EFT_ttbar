...
echo "output: $output"
wrong="f"
cd /afs/cern.ch/user/y/yuekai/EFT-ttbar/select/2018/condor_out_data/$1
file=$(ls ${1}.txt)
dir_f=$(cat $file)
...
mv $output/out*.txt /afs/cern.ch/user/y/yuekai/EFT-ttbar/select/2018/condor_out_data/$1
if [[ $wrong == "f" ]]
then
    echo "input file: $dir"

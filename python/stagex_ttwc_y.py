...
#y0 = (-1.177641)
class stagex_ttwc_y(PhysicsModel):
	...
	def getYieldScale(self,bin,process):
		...
		if self.acttbar:
			if not self.acmu:
				...
				self.modelBuilder.factory_("expr::r_tt_times_ci0000(\"1-1.5*@0+0.5*@0*@0\", y)")
				...
				self.modelBuilder.factory_("expr::r_tt_times_ci0000(\"1-1.5*@0+0.5*@0*@0\", y)")
				self.modelBuilder.factory_("expr::r_tt_times_ci0200(\"-0.5*@0+0.5*@0*@0\", y)")
				self.modelBuilder.factory_("expr::r_tt_times_ci0010(\"@0-1\", mu)")
				self.pois.append("y")
